      ...
      <Box p={2}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1">
              <strong>交易時間:</strong> {order.transactionDateTime ? new Date(order.transactionDateTime).toLocaleString('zh-TW', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: false }) : '未指定'}
            </Typography>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Typography variant="body1">
